...
<audio id="player" style="margin-top:10px;margin-bottom:10px" src="/assets/music/edayasneham.mp3" type="audio/mpeg" controls loop autoplay>Audio player not supported</audio>
